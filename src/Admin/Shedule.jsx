  ...
  return (
    <>
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
              ...
              <th scope="col" className="px-6 py-3">
                <div className="flex gap-4 mt-4">
                  ...
                  <input
                    type="datetime-local"
                    name="startingdttm"
                    value={data2.startingdttm || '2024-09-05T07:43:00.000Z'}
                  ...
                  <input
                    type="datetime-local"
                    name="endingdttm"
                    value={data2.endingdttm || '2024-09-05T08:43:00.000Z'}
                    onChange={handleChange}
                  />
                </div>
              </th>
              ...
              filteredData.map((session, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-right">
                    {data2.startingdttm || '2024-09-05T07:43:00.000Z'} -{' '}
                    {data2.endingdttm || '2024-09-05T08:43:00.000Z'}
                  </td>
                  <td className="px-6 py-4 text-right">
                    <input type="checkbox" />
                  </td>
        ...
        <div className="flex justify-end gap-4 mt-4 mr-1">
          <button
            className="bg-yellow-300 text-black px-4 py-2 rounded"
